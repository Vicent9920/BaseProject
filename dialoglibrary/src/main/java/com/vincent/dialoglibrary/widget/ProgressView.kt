            ...
            init {
                ...
                padding(
                    a.getDimensionPixelSize(
                        com.vincent.dialoglibrary.R.styleable.CircularProgressDrawable_cpd_padding,
                        0
                    )
                )
                initialAngle(a.getFloat(com.vincent.dialoglibrary.R.styleable.CircularProgressDrawable_cpd_initialAngle,0f))
                maxSweepAngle(a.getFloat(com.vincent.dialoglibrary.R.styleable.CircularProgressDrawable_cpd_maxSweepAngle,270f))
                minSweepAngle(a.getFloat( com.vincent.dialoglibrary.R.styleable.CircularProgressDrawable_cpd_minSweepAngle,1f) )
                strokeSize(
                    a.getDimensionPixelSize(
                ...
                inStepPercent(
                    a.getFloat(
                        com.vincent.dialoglibrary.R.styleable.CircularProgressDrawable_cpd_inStepPercent,
                        0.5f
                    )
                )
                outAnimDuration(
